...
img = visualkeras.show(
    ...
    options=FunctionalOptions(
        ...
        collapse_rules=[
            ...
            {"kind": "block", "selector": [layers.Dense, layers.Dropout], "repeat_count": 2, "annotation_position": "below"},
        ],
    ),
)
```

`show(...)` validates options by mode (for example, `mode="functional"` expects
